      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-8">
        ...
        <div className="flex flex-col gap-4 items-center md:items-start justify-center md:mb-12">
          ...
          <div className="flex space-x-4 mt-3 md:mt-0">
            <a href="#"><img src={faceIcon} className="w-5 h-5 opacity-80 hover:opacity-100" /></a>
            <a href="#"><img src={instaIcon} className="w-5 h-5 opacity-80 hover:opacity-100" /></a>
            <a href="#"><img src={XIcon} className="w-5 h-5 opacity-80 hover:opacity-100" /></a>
          </div>
        ...
        {isLoggedIn ? (
          // When Logged In → Show Opening Hours
          <div>
          ...
          // When NOT logged in → Show Features
          <div>
